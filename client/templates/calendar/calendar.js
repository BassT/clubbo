...
Template.calendar.onCreated(function() {
  ...
  template.autorun(function() {
    ...
    template.subscribe(
      "eventsByTimeIntervalAndTagsAndTeamIds",
      start,
      end,
      tags,
      teamIds
      ...
      function(start, end, timezone, callback) {
        ...
        if (tags && tags.length > 0) {
          ...
          for (i = 0; i < userNamesAndBirthdays.length; i = i + 1) {
            ...
            if (
              userNameAndBirthday.profile.birthday &&
              birthdayMoment.isBefore(end, "month")
            ) {
              birthdayEvents.push({
                ...
                title:
                  "Geb. " +
                  userNameAndBirthday.profile.firstName +
                  " " +
                  userNameAndBirthday.profile.lastName
              });
            }
          }
