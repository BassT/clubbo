...
Template.attendanceList.onCreated(function() {
  ...
  template.responsesByEventIdAndUserId = new ReactiveVar(
    responsesByEventIdAndUserId
  );
  ...
  template.autorun(function() {
    ...
    _.each(Template.currentData().attendances, function(response) {
      ...
      responsesByEventIdAndUserId[
        response.eventId + "_" + response.userId
      ] = response;
    });
...
Template.attendanceList.helpers({
  ...
  userMessage: function(user, event) {
    // DO NOT REMOVE - THIS HELPER IS IN USE!
    "use strict";
  ...
  userAbsence: function(user, event) {
    // DO NOT REMOVE - THIS HELPER IS IN USE!
    "use strict";
  ...
  responseValue: function(user, event) {
    "use strict";
    var response = Template.instance().responsesByEventIdAndUserId.get()[
      event._id + "_" + user._id
    ];
    if (response) {
